...
proc set_normal_error_rst*(input_rst: string): seq[string] {.discardable.} =
  ...
  ## `set_safe_error_rst() <#set_safe_error_rst>`_. See the document `Lazy reST
  ## error handling <docs/error_handling.rst>`_ for more information on what
  ## your ``input_rst`` variable needs to contain.
  ##
  ## Returns an empty string on success or a list of error messages indicating
  ## problems with ``input_rst``.
  result = @[]

proc set_safe_error_rst*(input_rst: string): seq[string] {.discardable.} =
  ...
  ## to call `set_safe_error_rst() <#set_safe_error_rst>`_. See the document
  ## `Lazy reST error handling <docs/error_handling.rst>`_ for more information
  ## on what your ``input_rst`` variable needs to contain.
  ##
  ## Returns an empty string on success or a list of error messages indicating
  ## problems with ``input_rst``.
  result = @[]
